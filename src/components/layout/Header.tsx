    ...
    return (
        <header className="w-full md:px-6 px-3 py-2 bg-[#e8e8e8] backdrop-blur-md top-0 z-50 text-white">
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                {/* CTA Button */}
                <a href="#_" className="hidden md:block relative items-center justify-start px-5 py-3 overflow-hidden font-bold rounded-full group bg-gradient-to-br from-[#ff8a05] via-[#ff5478] to-[#ff00c6]">
