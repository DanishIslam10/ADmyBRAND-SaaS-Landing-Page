      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12 md:gap-8 md:py-16 w-full max-w-7xl">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left px-2">
          ...
          >
            ...
            <Link href="#_" className="w-fit relative p-0.5 inline-flex items-center justify-center font-bold overflow-hidden group rounded-md">
            ...
            {/* Book a Demo Button */}
            <Link href="#_" className="w-fit relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white rounded-md shadow-2xl group">
